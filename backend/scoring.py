...
def player_score(player: Dict[str, Any], seasons: List[Dict[str, Any]],
    ...
    # Production = the BETTER of Sleeper's 2026-27 projection and the most
    # recent actual season (a conservative projection never assumes a player
    # in form will decline). Dataless rookies get the draft-slot curve; the
    # few played-but-unprojected players fall back to recent history.
    proj = projection or {}
    ...
    return {
        ...
        "s_fga": rs.get("fga"), "s_fg3a": rs.get("fg3a"),
